...
#define PROTOCOL_INGAME_OTHERPLAYER_CONNECT 0x100000000			// [세부틀 - 캐릭터관련] [서버->클라] 다른 유저 나간정보
...
#define PROTOCOL_PARTY_USER_INFO 0x8000000000					// [세부틀 - 파티관련] [서버->클라] 파티원정보
#define PROTOCOL_PARTY_LEADER_DELEGATE_RESULT 0x4000000000		// [세부틀 - 파티관련] [서버->클라] 리더 위임 결과
#define PROTOCOL_PARTY_LEADER_DELEGATE 0x2000000000				// [세부틀 - 파티관련] [서버->클라] 리더 위임 받은 유저 정보
#define PROTOCOL_PARTY_ROOM_REMOVE_RESULT 0x1000000000			// [세부틀 - 파티관련] [서버->클라] 파티방 사라졌을때 보내는 프로토콜

#define PROTOCOL_PARTY_USER_LEAVE_RESULT 0x800000000			// [세부틀 - 파티관련] [서버->클라] 탈퇴결과
#define PROTOCOL_PARTY_USER_LEAVE_INFO 0x400000000				// [세부틀 - 파티관련] [서버->클라] 탈퇴하는 유저 정보
#define PROTOCOL_PARTY_USER_KICK_RESULT 0x200000000				// [세부틀 - 파티관련] [서버->클라] 강퇴결과
#define PROTOCOL_PARTY_USER_KICK_INFO 0x100000000				// [세부틀 - 파티관련] [서버->클라] 강퇴당한 유저 정보

#define PROTOCOL_PARTY_USER_KICK 0x80000000						// [세부틀 - 파티관련] [서버->클라] 강퇴당한사람에게 보내는 프로토콜
#define PROTOCOL_PARTY_ROOM_ADD_USER 0x40000000					// [세부틀 - 파티관련] [서버->클라] 새로운 파티원이 들어옴
...
#define PROTOCOL_DUNGEON_STAGE_IN_REULST 0x40000000				// [세부틀 - 던전관련] [서버->클라] 스테이지에 입장결과
